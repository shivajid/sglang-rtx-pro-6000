...
| [`notes_on_kk3.md`](./notes_on_kk3.md) | Original raw working notes (kept as-is; distilled into this README) |
...
host RAM. Weights are served from Hyperdisk ML rather than downloaded per node.
...
- **HiCache on GB200** — experimental, unresolved.
